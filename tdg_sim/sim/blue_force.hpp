...
public:
    ...
    : CoupledModel(engine)
    {
        ...
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL03"), "BLUE-PLT1-SOL03", Side::BLUE, ForceType::RIFLE, {25,88}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL03"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL04"), "BLUE-PLT1-SOL04", Side::BLUE, ForceType::RIFLE, {26,88}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL04"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL05"), "BLUE-PLT1-SOL05", Side::BLUE, ForceType::RIFLE, {27,88}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL05"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL06"), "BLUE-PLT1-SOL06", Side::BLUE, ForceType::RIFLE, {23,89}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL06"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL07"), "BLUE-PLT1-SOL07", Side::BLUE, ForceType::RIFLE, {24,89}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL07"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL08"), "BLUE-PLT1-SOL08", Side::BLUE, ForceType::RIFLE, {25,89}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL08"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL09"), "BLUE-PLT1-SOL09", Side::BLUE, ForceType::RIFLE, {26,89}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL09"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL10"), "BLUE-PLT1-SOL10", Side::BLUE, ForceType::RIFLE, {27,89}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL10"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL11"), "BLUE-PLT1-SOL11", Side::BLUE, ForceType::RIFLE, {23,90}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL11"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL12"), "BLUE-PLT1-SOL12", Side::BLUE, ForceType::RIFLE, {24,90}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL12"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL13"), "BLUE-PLT1-SOL13", Side::BLUE, ForceType::RIFLE, {25,90}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL13"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL14"), "BLUE-PLT1-SOL14", Side::BLUE, ForceType::RIFLE, {26,90}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL14"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL15"), "BLUE-PLT1-SOL15", Side::BLUE, ForceType::RIFLE, {27,90}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL15"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL16"), "BLUE-PLT1-SOL16", Side::BLUE, ForceType::RIFLE, {23,91}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL16"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL17"), "BLUE-PLT1-SOL17", Side::BLUE, ForceType::RIFLE, {24,91}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL17"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL18"), "BLUE-PLT1-SOL18", Side::BLUE, ForceType::RIFLE, {25,91}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL18"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL19"), "BLUE-PLT1-SOL19", Side::BLUE, ForceType::RIFLE, {26,91}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL19"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL20"), "BLUE-PLT1-SOL20", Side::BLUE, ForceType::RIFLE, {27,91}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL20"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL21"), "BLUE-PLT1-SOL21", Side::BLUE, ForceType::RIFLE, {23,92}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL21"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL22"), "BLUE-PLT1-SOL22", Side::BLUE, ForceType::RIFLE, {24,92}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL22"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL23"), "BLUE-PLT1-SOL23", Side::BLUE, ForceType::RIFLE, {25,92}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL23"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL24"), "BLUE-PLT1-SOL24", Side::BLUE, ForceType::RIFLE, {26,92}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL24"));
        plt1.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT1-SOL25"), "BLUE-PLT1-SOL25", Side::BLUE, ForceType::RIFLE, {27,92}})); plt1_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT1-SOL25"));

        // === BLUE PLT2 ===
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL01"), "BLUE-PLT2-SOL01", Side::BLUE, ForceType::RIFLE, {70,123}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL01"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL02"), "BLUE-PLT2-SOL02", Side::BLUE, ForceType::RIFLE, {71,123}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL02"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL03"), "BLUE-PLT2-SOL03", Side::BLUE, ForceType::RIFLE, {72,123}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL03"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL04"), "BLUE-PLT2-SOL04", Side::BLUE, ForceType::RIFLE, {73,123}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL04"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL05"), "BLUE-PLT2-SOL05", Side::BLUE, ForceType::RIFLE, {74,123}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL05"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL06"), "BLUE-PLT2-SOL06", Side::BLUE, ForceType::RIFLE, {70,124}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL06"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL07"), "BLUE-PLT2-SOL07", Side::BLUE, ForceType::RIFLE, {71,124}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL07"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL08"), "BLUE-PLT2-SOL08", Side::BLUE, ForceType::RIFLE, {72,124}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL08"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL09"), "BLUE-PLT2-SOL09", Side::BLUE, ForceType::RIFLE, {73,124}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL09"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL10"), "BLUE-PLT2-SOL10", Side::BLUE, ForceType::RIFLE, {74,124}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL10"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL11"), "BLUE-PLT2-SOL11", Side::BLUE, ForceType::RIFLE, {70,125}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL11"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL12"), "BLUE-PLT2-SOL12", Side::BLUE, ForceType::RIFLE, {71,125}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL12"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL13"), "BLUE-PLT2-SOL13", Side::BLUE, ForceType::RIFLE, {72,125}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL13"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL14"), "BLUE-PLT2-SOL14", Side::BLUE, ForceType::RIFLE, {73,125}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL14"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL15"), "BLUE-PLT2-SOL15", Side::BLUE, ForceType::RIFLE, {74,125}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL15"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL16"), "BLUE-PLT2-SOL16", Side::BLUE, ForceType::RIFLE, {70,126}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL16"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL17"), "BLUE-PLT2-SOL17", Side::BLUE, ForceType::RIFLE, {71,126}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL17"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL18"), "BLUE-PLT2-SOL18", Side::BLUE, ForceType::RIFLE, {72,126}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL18"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL19"), "BLUE-PLT2-SOL19", Side::BLUE, ForceType::RIFLE, {73,126}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL19"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL20"), "BLUE-PLT2-SOL20", Side::BLUE, ForceType::RIFLE, {74,126}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL20"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL21"), "BLUE-PLT2-SOL21", Side::BLUE, ForceType::RIFLE, {70,127}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL21"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL22"), "BLUE-PLT2-SOL22", Side::BLUE, ForceType::RIFLE, {71,127}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL22"));
        plt2.push_back(new Soldier(engine, Entity{env->RegisterEntityIdByName("BLUE-PLT2-SOL23"), "BLUE-PLT2-SOL23", Side::BLUE, ForceType::RIFLE, {72,127}})); plt2_Ids.push_back(env->QueryEntityIdByName("BLUE-PLT2-SOL23"));
